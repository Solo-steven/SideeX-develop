...
export async function getUserInfo(userName, userToken){
    let repoCount = await getRepoCount(userName, userToken);
    let repoList  = await getRepoList(userName, userToken, repoCount);
    return repoList;
}

export async function getReposInfo(userName, userToken, repoList){
    let branchCount, branchList, userData ;
...
export async function getUserData(userName, userToken){
    let repoCount, repoList, branchCount , branchList , userData= [];
